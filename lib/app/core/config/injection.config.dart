...
import 'package:easy_stock/app/presentation/login/cubit/auth_cubit.dart'
    as _i171;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i171.AuthCubit>(() => _i171.AuthCubit());
    gh.factory<_i796.AuthDatasource>(
      () => _i796.AuthDatasource(gh<_i361.Dio>()),
    );
